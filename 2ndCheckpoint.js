...
//------------------------------------------------------------------------------------------
// FUNÇÃO CRONOMETRO - TEMPO != PREPARO PADRÃO
//------------------------------------------------------------------------------------------
// Faz incremento de tempo até o valor determinado para o preparo do
// prato declarado na variável 'tempo'
// var cronoTempo = function()
// {
//     for (i=1;i<=tempo;i++)
...
let pipoca = function()
{
    ...
    else
    {
        ...
        console.log("Preparando...")
        function dezSegundos(){console.log("10 segundos. Prato Pronto, bom apetite. :D")}
...
let macarrao = function()
{
    ...
    else
    {
        // Instrução para o tempo padrão de preparo
          console.log("Preparando...")
          function oitoSegundos(){console.log("8 segundos. Prato Pronto, bom apetite. :D")}
...
let carne = function()
{
    ...
    else
    {
        // Instrução para o tempo padrão de preparo
          console.log("Preparando...")
          function quinzeSegundos(){console.log("15 segundos. Prato Pronto, bom apetite. :D")}
...
let feijao = function()
{
    ...
    else
    {
        // Instrução para o tempo padrão de preparo
          console.log("Preparando...")
          function dozeSegundos(){console.log("12 segundos. Prato Pronto, bom apetite. :D")}
